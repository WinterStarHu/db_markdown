# PostgreSQL: Documentation: 18: Index
...
_PG_oauth_validator_module_init, Initialization Functions
...
configuration parameter, Automatic Vacuuming
storage parameter, Storage Parameters
autovacuum_worker_slots configuration parameter, Automatic Vacuuming
...
casefold, String Functions and Operators
cast, CREATE CAST
...
crc32, Binary String Functions and Operators
crc32c, Binary String Functions and Operators
...
debug_copy_parse_plan_trees configuration parameter, Developer Options
...
debug_raw_expression_coverage_test configuration parameter, Developer Options
debug_write_read_parse_plan_trees configuration parameter, Developer Options
decimal (see numeric)
DECLARE, DECLARE
...
file_extend_method configuration parameter, Disk
...
max_parallel_maintenance_workers configuration parameter, Worker Processes
max_parallel_workers configuration parameter, Worker Processes
max_parallel_workers_per_gather configuration parameter, Worker Processes
...
max_worker_processes configuration parameter, Worker Processes
md5, String Functions and Operators, Binary String Functions and Operators
MD5, Password Authentication
md5_password_warnings configuration parameter, Authentication
...
RETURNING, Returning Data from Modified Rows, Merge Support Functions
...
num_os_semaphores configuration parameter, Preset Options
NVL, COALESCE
O
OAuth Authorization/Authentication, OAuth Authorization/Authentication
OAuth Validators, OAuth Validator Modules
oauth_validator_libraries configuration parameter, Authentication
...
output_plugin_libraries configuration parameter, Sending Servers
...
parallel_leader_participation configuration parameter, Worker Processes
...
passwordcheck.min_password_length configuration parameter, Configuration Parameters
...
pgcrypto.builtin_crypto_enabled configuration parameter, Configuration Parameters
...
PGMAXPROTOCOLVERSION, Environment Variables
PGMINPROTOCOLVERSION, Environment Variables
...
pg_buffercache_evict_all, pg_buffercache — inspect PostgreSQL buffer cache state
pg_buffercache_evict_relation, pg_buffercache — inspect PostgreSQL buffer cache state
pg_buffercache_numa, pg_buffercache — inspect PostgreSQL buffer cache state
...
pg_buffercache_usage_counts, pg_buffercache — inspect PostgreSQL buffer cache state
...
pg_class, pg_class
pg_clear_attribute_stats, Database Object Management Functions
pg_clear_relation_stats, Database Object Management Functions
...
pg_get_acl, Object Information and Addressing Functions
...
pg_get_loaded_modules, Session Information Functions
pg_get_multixact_members, Transaction ID and Snapshot Information Functions
pg_get_object_address, Object Information and Addressing Functions
pg_get_partition_constraintdef, System Catalog Information Functions
...
pg_locks, pg_locks
pg_logicalinspect, pg_logicalinspect — logical decoding components inspection
...
pg_ls_summariesdir, Generic File Access Functions
...
pg_restore_attribute_stats, Database Object Management Functions
pg_restore_relation_stats, Database Object Management Functions
pg_rewind, pg_rewind
...
pg_stat_get_backend_io, Statistics Functions
...
pg_stat_get_backend_wal, Statistics Functions
...
pg_stat_reset_backend_stats, Statistics Functions
...
PQAUTHDATA_OAUTH_BEARER_TOKEN, Hook Types
PQAUTHDATA_PROMPT_OAUTH_DEVICE, Hook Types
...
PQfullProtocolVersion, Connection Status Functions
PQgetAuthDataHook, Authdata Hooks
...
PQsetAuthDataHook, Authdata Hooks
...
reverse, String Functions and Operators, Binary String Functions and Operators
...
ssl_groups configuration parameter, SSL
...
ssl_tls13_ciphers configuration parameter, SSL
...
synchronized_standby_slots configuration parameter, Primary Server
...
track_cost_delay_timing configuration parameter, Cumulative Query and Index Statistics
...
UUID, UUID Type, UUID Functions, PostgreSQL Features, PostgreSQL Features
generating, UUID Functions
uuid-ossp, uuid-ossp — a UUID generator
uuidv4, UUID Functions
uuidv7, UUID Functions
...
configuration parameters, Vacuuming
VACUUM, VACUUM
vacuumdb, vacuumdb
vacuumlo, vacuumlo
...
vacuum_failsafe_age configuration parameter, Freezing
vacuum_freeze_min_age configuration parameter, Freezing
vacuum_freeze_table_age configuration parameter, Freezing
vacuum_index_cleanup storage parameter, Storage Parameters
vacuum_max_eager_freeze_failure_rate
configuration parameter, Freezing
storage parameter, Storage Parameters
vacuum_multixact_failsafe_age configuration parameter, Freezing
vacuum_multixact_freeze_min_age configuration parameter, Freezing
vacuum_multixact_freeze_table_age configuration parameter, Freezing
vacuum_truncate
configuration parameter, Default Behavior
storage parameter, Storage Parameters
